...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 设置图片链接。
        task.put("url", "https://img2.baidu.com/it/u=3870267042,838024396&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=750");
        ...
        httpBody.put("extras", "{\"type\":\"advanced\"}");
